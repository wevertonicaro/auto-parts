import {
    ...
    createGroupUserPath,
} from '../useCases/create/CreateGroupUser.swagger'
import {
    deleteGroupUserDefinitions,
    deleteGroupUserPath,
} from '../useCases/delete/DeleteGroupUser.swagger'
import { getGroupUserDefinitions, getGroupUserPath } from '../useCases/find/FindGroupUser.swagger'
import {
    updateGroupUserDefinitions,
    updateGroupUserPath,
} from '../useCases/update/UpdateGroupUser.swagger'

const tagsGroupUser = {
    name: 'Grupo de usuários',
    description:
        'Processos a respeito de criação, busca, atualização e exclusão de grupo de usuários',
}
...
export { definitionsGroupUser, pathGroupUser, tagsGroupUser }
